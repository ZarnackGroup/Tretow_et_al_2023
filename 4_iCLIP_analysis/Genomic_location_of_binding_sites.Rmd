...
#   exactly one biotype to the binding site
...
their averaged TPM value was $\ge$ 1.
...
For the cooperatively enhanced (Coop-Enh), repressed (Coop-Rep) and non-
regulated events (nonReg) we determined if they are bound (plot1) and 
