...
Based on the MAJIQ quantification, dose-response curves should be 
...
-   nH (the Hill coefficient): -Inf to +Inf (non constraints)
...
The output is a drc model object to which I add some meta information
like the event identifier, the name of the underlying gene as well as a
...
Events with a pseudoR2 \< 0.75 are removed to ensure a hih quality of
fitted events.
